...
DATA_DIR_HOW2SIGN = {
    'train': '/mnt/gpid08/datasets/How2Sign/How2Sign_RGB-D/videos/train/All',
    'val': '/mnt/gpid08/datasets/How2Sign/How2Sign_RGB-D/videos/val/All',
    'test': '/mnt/gpid08/datasets/How2Sign/How2Sign_RGB-D/videos/test/All',
}
...
def MediaPipe_to_h5(dataset: str = 'How2Sign'):
    ...
    for split in SPLITS:
        ...
        for p in range(start, partition):
            ...
            h5f = h5py.File(f'/mnt/gpid08/datasets/How2Sign/How2Sign_RGB-D/videos/{split}/MediaPipe_{split}_worldlmarks.h5', 'a')
