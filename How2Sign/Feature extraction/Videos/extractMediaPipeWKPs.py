...
def MediaPipe_to_h5(dataset: str = 'How2Sign'):
    ...
    for split in SPLITS:
        ...
        for p in range(start, partition):
            ...
            h5f = h5py.File(f'/mnt/gpid08/datasets/How2Sign/How2Sign/video_level/train/rgb_front/features/mediapipe/world-landmarks-V2/MediaPipe_{split}_worldlmarks.h5', 'a')
